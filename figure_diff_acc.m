...
drawPointMtxROW = 1; 
for NUM_PILOT = [64 200 500 5000 50000 NUM_ALL_USERS]  % No. of pilot [64 200 500 5000 50000 NUM_ALL_USERS]  
    ...
    for NUM_ACT_USERS = 5:5:100 % 5:5:100
        drawPointMtx1(1,drawPointMtxColumn) = NUM_ACT_USERS;
        drawPointMtx2(1,drawPointMtxColumn) = NUM_ACT_USERS;
