...
NUM_ROW  = 20; % the first row for num of act users
drawPointMtx1 = zeros(NUM_ROW,1);%For pilot correct ratio
% drawPointMtx2 = zeros(NUM_ROW,1);%For channel mse
drawPointMtx2 = zeros(NUM_ROW,1);%For Activity correct ratio
...
drawPointMtxROW = 1; 
for NUM_PILOT =  [64 100 200 300 400 500 NUM_ALL_USERS] % No. of pilot 
    ...
    for SNR = 0:5:40  
        par.SNR = SNR;
        drawPointMtx1(1,drawPointMtxColumn) = SNR;
        drawPointMtx2(1,drawPointMtxColumn) = SNR;
        drawPointMtx3(1,drawPointMtxColumn) = SNR;        
        NUM_ITR = 500;
        for itr = 1:NUM_ITR
...
%             fprintf('NUM_PILOT = %d, SNR = %d, itr = %d \n',NUM_PILOT,SNR,itr);
...
drawPointMtx1(2:NUM_ROW,2:10)  = drawPointMtx1(2:NUM_ROW,2:10) ./ NUM_ITR;
drawPointMtx2(2:NUM_ROW,2:10)  = drawPointMtx2(2:NUM_ROW,2:10) ./ NUM_ITR;
drawPointMtx3(2:NUM_ROW,2:10)  = drawPointMtx3(2:NUM_ROW,2:10) ./ NUM_ITR;

% save('figure_diff_snr_act35_l72_ue1000000','drawPointMtx1','drawPointMtx2','drawPointMtx3')
